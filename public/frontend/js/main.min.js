        ...
        (Riode.$window = $(window)),
            ...
            (Riode.defaults = {
                ...
                templateCartAddedAlert:
                    '<div class="alert alert-simple alert-btn cart-added-alert"><a href="{{url("mycart")}}" class="btn btn-success btn-md">View Cart</a><span>"{{name}}" has been added to your cart.</span><button type="button" class="btn btn-link btn-close"><i class="d-icon-times"></i></button></div>',
                zoomImage: {
                    responsive: !0,
                                        ...
                                        (i.closest(".product-popup").length ||
                                            ...
                                            Riode.Minipopup.open({
                                                ...
                                                count: i
                                                    ...
                                                    .val(),
                                                actionTemplate:
                                                    '<div class="action-group d-flex mt-3"><a href="{{url("mycart")}}" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="{{url("mycart")}}" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                            });
                                    }
                                );
                            })(this),
                                        ...
                                        (i.closest(".product-popup").length ||
                                            ...
                                            Riode.Minipopup.open({
                                                ...
                                                count: i
                                                    ...
                                                    .val(),
                                                actionTemplate:
                                                    '<div class="action-group d-flex mt-3"><a href="{{url("mycart")}}" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Compare</a><a href="{{url("mycart")}}" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                            });
                                    }
                                );
                            })(this);
                                          ...
                                          Riode.Minipopup.open({
                                              ...
                                              count:
                                                  n.find(".quantity").length > 0
                                                      ...
                                                      : 1,
                                              actionTemplate:
                                                  '<div class="action-group d-flex"><a href="{{url("mycart")}}" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="{{url("mycart")}}" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                          }))
                                    : n.hasClass("product-single") ||
                                      Riode.Minipopup.open({
                                          message: "Successfully Added",
                                    ...
                                    Riode.Minipopup.open({
                                        ...
                                        count:
                                            t.find(".quantity").length > 0
                                                ...
                                                : 1,
                                        actionTemplate:
                                            '<div class="action-group d-flex"><a href="{{url("mycart")}}" class="btn btn-sm btn-outline btn-primary btn-rounded">Compare</a><a href="{{url("mycart")}}" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                                    });
                            }
                        );
                },
