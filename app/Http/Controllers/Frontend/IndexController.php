...
class IndexController extends Controller
{
    public function index(){
        ...
        $products = Product::where('status',1)->orderBy('id','DESC')->limit(16)->get(); 
        
        $blogpost = BlogPost::latest()->get();
        $sliders = Slider::where('status',1)->orderBy('id','DESC')->limit(3)->get();
    	$categories = Category::orderBy('category_name_en','ASC')->get();  
        $featured = Product::where('featured',1)->orderBy('id','DESC')->limit(16)->get();
    	$hot_deals = Product::where('hot_deals',1)->where('discount_price','!=',NULL)->orderBy('id','DESC')->limit(3)->get();

    	$special_offer = Product::where('special_offer',1)->orderBy('id','DESC')->limit(16)->get();

    	$special_deals = Product::where('special_deals',1)->orderBy('id','DESC')->limit(13)->get();
    ...
    public function TagWiseProduct($tag){
        // $products = Product::where('status',1)->orderBy('id','DESC')->limit(16)->get();
		$products = Product::where('status',1)->where('product_tags_en',$tag)->where('product_tags_hin',$tag)->orderBy('id','DESC')->paginate(32);
		$categories = Category::orderBy('category_name_en','ASC')->get();
  ...
  // Subcategory wise data
	public function SubCatWiseProduct(Request $request, $subcat_id,$slug){
		$products = Product::where('status',1)->where('subcategory_id',$subcat_id)->orderBy('id','DESC')->paginate(32);
		$categories = Category::orderBy('category_name_en','ASC')->get();
  ...
  // Sub-Subcategory wise data
	public function SubSubCatWiseProduct($subsubcat_id,$slug){
		$products = Product::where('status',1)->where('subsubcategory_id',$subsubcat_id)->orderBy('id','DESC')->paginate(36);
		$categories = Category::orderBy('category_name_en','ASC')->get();
 ...
 // Product Seach 
   ...
   public function ContactForm(Request $request){
    ...
    'created_at' => Carbon::now(),
       ...
       $notification = array(
            'message' => 'Your Query submitted Succesfully',
            'alert-type' => 'success',
        );
