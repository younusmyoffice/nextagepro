                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">All Return Orders  <span class="badge rounded-pill bg-warning text-dark"> {{ count($orders) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                    ...
                    <!--end breadcrumb-->
                      ...
                      <div class="card">
                        <div class="card-header py-3">
                          <h6 class="mb-0">All Return Orders List</h6>
                        </div>
                        <div class="card-body">
                           <div class="row">
                                            ...
                                            @foreach ($orders as $item)
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
															...
															<a target="_blank" href="" class="badge bg-success" data-bs-toggle="tooltip" data-bs-placement="bottom"  title="Returned">
																<i class="bi bi-cloud-download-fill me-0"></i> Return Success</a> 
