                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Published Reviews  <span class="badge rounded-pill bg-warning text-dark"> {{ count($review) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                    ...
                    <!--end breadcrumb-->
                      ...
                      <div class="card">
                        <div class="card-header py-3">
                          <h6 class="mb-0">Published Reviews List</h6>
                        </div>
                        <div class="card-body">
                           <div class="row">
                                                ...
                                                <tr>
												  ...
												  <td>
                                                    ...
                                                    <div class="table-actions d-flex align-items-center gap-3 fs-6" >
															...
															<a href="{{ route('delete.review',$item->id) }}"  class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete" id="delete">
