                    ...
                    <!--end breadcrumb-->
                      ...
                      <div class="card">
                        <div class="card-header py-3">
                          <h6 class="mb-0">Edit subsubcategory</h6>
                        </div>
                        <div class="card-body">
                           <div class="row">
                             <div class="col-12 col-lg-12 d-flex">
                               <div class="card border shadow-none w-100">
                                 <div class="card-body">
                                   <form class="row g-3" method="POST" action="{{route('subsubcategory.update')}}">
                                    @csrf 
                                     <input type="hidden" name="id" value="{{ $subsubcategories->id }}">			
                                    
                                    <div class="col-12">
                                       <label class="form-label">subsubcategory Name English</label>
                                       <input type="text" name="subsubcategory_name_en" class="form-control" placeholder="subsubcategory name ENG" value="{{$subsubcategories->subsubcategory_name_en}}"> 
                                     </div>
                                     ...
                                     <div class="col-12">
                                      ...
                                      <input type="text" name="subsubcategory_name_hin"class="form-control" placeholder="subsubcategory  name HIN" value="{{$subsubcategories->subsubcategory_name_hin}}">
                                    </div>
                                    ...
                                    <div class="col-12">
                                      <div class="d-grid">
                                        <input class="btn btn-primary" type="submit" value="Update"placeholder="Update subsubcategory">
                                      </div>
                                    </div>
                                   </form>
                                 </div>
