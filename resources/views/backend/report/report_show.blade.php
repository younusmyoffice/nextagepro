                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Orders  <span class="badge rounded-pill bg-warning text-dark"> {{ count($orders) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                                          ...
                                          <tbody>
                                            @foreach ($orders as $item)
                                                ...
                                                <tr>
												  ...
												  <td style="text-align:center;"> <span class="badge rounded-pill bg-info text-dark">{{ $item->status }} </span>  </td>
