                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Confirmed Orders  <span class="badge rounded-pill bg-warning text-dark"> {{ count($orders) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                    ...
                    <!--end breadcrumb-->
                      ...
                      <div class="card">
                        <div class="card-header py-3">
                          <h6 class="mb-0">Confirmed Orders List</h6>
                        </div>
                        <div class="card-body">
                           <div class="row">
                                          ...
                                          <tbody>
                                            @foreach ($orders as $item)
                                                ...
                                                <tr>
												  ...
												  <td > 
                            <span class="badge bg-light-success text-success w-100 rounded-pill ">{{ $item->status }} </span> 
