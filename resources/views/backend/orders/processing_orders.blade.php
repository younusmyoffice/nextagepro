                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Processing Orders  <span class="badge rounded-pill bg-warning text-dark"> {{ count($orders) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                    ...
                    <!--end breadcrumb-->
                      ...
                      <div class="card">
                        <div class="card-header py-3">
                          <h6 class="mb-0">Processing Orders List</h6>
                        </div>
                        <div class="card-body">
                           <div class="row">
                            ...
                            <span class="badge bg-light-warning text-warning w-100 rounded-pill">{{ $item->status }} </span> 
                           </td>
                                                  
                                                  <td>
                                                    <div class="table-actions d-flex align-items-center gap-3 fs-6" >
													
															<a href="{{ route('pending.order.details',$item->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"> Edit</i> </a>
