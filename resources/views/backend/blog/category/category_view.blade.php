                      ...
                      <div class="ps-3">
                        <nav aria-label="breadcrumb">
                          <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Blog Category  <span class="badge rounded-pill bg-warning text-dark"> {{ count($blogcategory) }}</span></li>
                          </ol>
                        </nav>
                      </div>
                      <div class="ms-auto">
                           ...
                           <div class="row">
                             <div class="col-12 col-lg-4 d-flex">
                               <div class="card border shadow-none w-100">
                                 <div class="card-body">
                                   <form class="row g-3" method="POST" action="{{route('blogcategory.store')}}">
                                    @csrf 
                                    <div class="col-12">
                                       <label class="form-label">Blog Category   English</label>
                                       <input type="text" name="blog_category_name_en" class="form-control" placeholder="Blog Category   ENG">
                                     </div>
                                     ...
                                     @enderror
                                     <div class="col-12">
                                      <label class="form-label">Blog Category   Hindi</label>
                                      <input type="text" name="blog_category_name_hin"class="form-control" placeholder="Category  name HIN">
                                    </div>
                                    ...
                                    <div class="col-12">
                                      <div class="d-grid">
                                        <input class="btn btn-primary" type="submit" placeholder="Add Blog category" value="Add New">
                                      </div>
                                    </div>
                                   </form>
                                 </div>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                      ...
                                                      <a href="{{route('blog.category.edit',$item->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
